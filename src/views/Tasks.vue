    ...
    <div v-if="showTaskModal" class="modal" @click="closeTaskModal">
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          <TaskForm @submit="submitTask" @cancel="closeTaskModal" />
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    saveEditedTask() {
      const startDateTime = new Date(`${this.editedTask.due}T${this.editedTask.startTime}`);
      const endDateTime = new Date(`${this.editedTask.due}T${this.editedTask.endTime}`);
